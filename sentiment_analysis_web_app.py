...
st.write('This is a web app based on Machine learning algorithms, which PREDICTS IF A PERSON HAS LIKE OR DISLIKE TOWARDS A MOVIE, given their comment on the respective movie.')
st.write('Write a comment on a movie that you wish, you want to comment in the below space.The comment shall not be too short.')
